...
* **Prefilters:** allows to apply user-defined C callbacks **prior to** the filter pipeline during compression.  See `test_prefilter.c <https://github.com/Blosc/c-blosc2/blob/main/tests/test_prefilter.c>`_ for an example of use.
